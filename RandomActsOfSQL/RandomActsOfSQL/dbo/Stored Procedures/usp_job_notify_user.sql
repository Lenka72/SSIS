...
BEGIN
        ...
        DECLARE @Email                VARCHAR(100)
			   ...
			   ,@ScheduledProcessNotification NVARCHAR(50);

        SET @CrLf = CHAR(10) + CHAR(13);

        IF @ProcessNickname IS NULL
                SET @ProcessNickname = REPLACE(@ProcessName, 'Valuation - ', '');
		...
		SET @ScheduledProcessNotification = TRY_CONVERT(NVARCHAR(50), dbo.fn_get_environment_variable_value('Utilities', 'Utility', 'ScheduledProcessNotification'));
        ...
        WITH MostRecent AS (SELECT      P.ProcessId
                                       ...
                                       ,P.ProcessCompleted
                                       ,P.Status
                                       ,REPLACE(P.UserId, 'PNMAC\', '')                    AS UserId
